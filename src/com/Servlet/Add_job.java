...
public class Add_job extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<h3><b>Add Jobs</b></h3>");             
	    out.print("</div>");         
		out.print("<form action='add_job' method = 'post'>");
		out.print("<input type = 'hidden' value = '' name = 'id'>");
	    out.print("<div class = 'form-group'>");         
		out.print("<label>Enter Title</label>");          
	    out.print("<input type = 'text' name = 'title' required class = 'form-control' value = ''>");           
	    out.print(" </div>");       
		...
		out.print("<option value = ''>Choose</option>");             
        ...
        out.print("</div>");          	  
		 ...
		 out.print(" <textarea required rows = '4' cols = '' name = 'desc' class = 'form-control'></textarea>");         
	     out.print("</div>");          
		 out.print("<button class = 'btn btn-success'>Publish Job</button>");   
		 out.print("</form>");    
	     out.print("</div>");          
	     out.print("</div>");          
	     out.print("</div>");          
